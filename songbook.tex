%%%%%% rcsid = @(#)$Id: sample-sb.tex,v 1.15 2002/04/26 00:55:40 christopher Exp $
%%%%%%
%%
%%      ===============================
...
%                  song.
%%%
\newcommand{\RelDate}{13 November'99}
...
\begin{song}{How Lovely Is Your Dwelling Place}{D}
  ...
  \begin{SBOpGroup}
    How \Ch{D}{love}ly is Your \Ch{G}{dwell}ing place, \Ch{D}{} O Lord of \Ch{G}{Hosts.}
    
    My \Ch{D}{soul} longs and \Ch{G}{yearns} for Your \Ch{A7}{courts,}
    
    And my \Ch{D}{heart} and \Ch{G}{flesh} sing for \Ch{A7}{joy} to the living \Ch{D}{God.} \Ch{G}{} \Ch{D}{}
    
    One \Ch{D}{day} in Your \Ch{G}{pres}ence is far \Ch{D}{bet}ter to me than \Ch{G}{gold}
    
    Or to \Ch{D}{live} my \Ch{G}{whole} life somewhere \Ch{Em}{else.} \Ch{A7}{}
    
    And \Ch{D}{I} would rather \Ch{G}{be} a \Ch{D}{door} keeper in Your \Ch{G}{house}
    
    Than to \Ch{D}{take} my \Ch{G}{fate} upon my\Ch{Em}{self.} \Ch{A7}{}
    
    You are my \Ch{D}{Sun} and my \Ch{G}{Shield,}
    
    You're my \Ch{D}{Lov}er from the \Ch{G}{start,}
    
    And the \Ch{D}{high}way to Your \Ch{A7}{city} runs through my \Ch{G}{heart.} \Ch{D}{}
  \end{SBOpGroup}
\end{song}
